...
def extract_date_from_filename(filename: str) -> Optional[str]:
    ...
    full_datetime_patterns = [
        # IMG_20240321_174532, PXL_20240321_174532, 20240321-174532
        r"(?<!\d)(20\d{2})[-_.]?([01]\d)[-_.]?([0-3]\d)[ _T.-]+([0-2]\d)[.:_-]?([0-5]\d)[.:_-]?([0-5]\d)(?!\d)",
        # Screenshot 2024-03-21 at 17.45.32, WhatsApp-like exports
        r"(?<!\d)(20\d{2})[-_.]([01]\d)[-_.]([0-3]\d).*?([0-2]\d)[.:_-]([0-5]\d)[.:_-]([0-5]\d)(?!\d)",
    ]
